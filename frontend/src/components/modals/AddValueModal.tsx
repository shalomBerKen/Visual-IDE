...
import { createSimpleValue, createArrayValue, createObjectValue, createFunctionCallValue } from '../../types/values';
...
export const AddArrayItemModal: React.FC<AddArrayItemProps> = ({ isOpen, onClose, onAdd }) => {
  const [selectedType, setSelectedType] = useState<'simple' | 'array' | 'object' | 'function-call'>('simple');
  ...
  const handleAdd = () => {
    ...
    if (selectedType === 'simple') {
      ...
      value = createFunctionCallValue(functionName, []);
    }
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              onClick={() => setSelectedType('function-call')}
              className={`px-4 py-2 text-sm font-medium rounded-lg border-2 transition-colors ${
          ...
          <div>
            ...
            <div className="mt-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-sm text-blue-800">
                Arguments can be added after creation using the cascading panels.
              </p>
            </div>
          </div>
        )}

        {selectedType !== 'simple' && selectedType !== 'function-call' && (
